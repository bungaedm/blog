...
**정의**
$$\text{Let } Z_i = \frac{X_i-\mu}{\sigma}, m(t) = mgf_{Z_1}(t) \\
\text{and notice that } E(Z_i) = 0, Var(Z_i) = 1$$
...
$$1) \ log(1+A) = A - \frac{1}{2}A^2 + \frac{1}{3}A^3 - \frac{1}{4}A^4 + \cdots \\
2) \ m(0) = 1, m'(0) = E(Z_1) = 0, m''(0) = E(Z_1^2) = Var(Z_1) = 1$$
